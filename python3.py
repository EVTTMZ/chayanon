...
print(this_tuple)
print(thpe(this_tuple))
print(len(this_tuple))
print(this_tuple[2])


this_tuple2 = ("apple","banana","coconut")
this_tuple3 = list(this_tuple2)
print(this_tuple3-list)
print(type(this_tuple3-list))
...
this_tupele7 = tuple(this_tuple6_list)
print(this_tupele7)
print(type(this_tupele7))

this_tuple8 = ("apple","banana","coconut")
this_tuple9_list = list(this_tuple8)
this_tuple9_list.remove("banana")
this_tupele10 = tuple(this_tuple9_list)
print(this_tupele10)
print(type(this_tupele10))
...
print(this_set8,len(this_set8))
del this_set8
#print(this_set8,len(thhis_srt8))
